...
static char *ExpectedTrace[] = {
    ...
    "AbortValidateCallback 300 VALID",
    "ABORT when Count = 95",
    "Segment 1",
    ...
    "ABORT when Count = 300",
    "Segment 3",
    "AbortStartCallback Condition TRUE - Skipping next segment (95 <= 300)",
    "EndCallback",
};
...
bool 
UnitTestAbortAtEndTrue(ENGINE_HANDLE Engine)
{
    //------------------------------------
