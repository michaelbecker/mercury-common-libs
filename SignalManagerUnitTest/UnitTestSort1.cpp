...
{    7.700000,   10.100000,    1.000000,    8.700000,   11.100000,    1.100000,   10.440000,   19.800000,   12.100000,   28.500000,   38.940000,  },
...
static double  fcnB ( SIGNAL_HANDLE cs, void *UserData)
{
    ...
    double x = SmGetInputResult(cs, 0, 0);
    double y = SmGetInputResult(cs, 0, 1);
...
static double  fcnC ( SIGNAL_HANDLE cs, void *UserData)
{
    ...
    double z = SmGetInputResult(cs, 0, 0);
...
static double  fcnD ( SIGNAL_HANDLE cs, void *UserData)
{
    ...
    double x = SmGetInputResult(cs, 0, 0);
    double b = SmGetInputResult(cs, 0, 1);
...
static double  fcnG ( SIGNAL_HANDLE cs, void *UserData)
{
    ...
    double c = SmGetInputResult(cs, 0, 1);
...
static double  fcnH ( SIGNAL_HANDLE cs, void *UserData)
{
    ...
    double g = SmGetInputResult(cs, 0, 0);
    double f = SmGetInputResult(cs, 0, 1);
...
bool UnitTestSort1(void)
{
    ...
    printf("Executing UnitTestSort1\n");
